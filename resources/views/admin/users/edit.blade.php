                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="active" {{ $user->status == 'active' ? 'selected' : '' }}>فعال
                                        </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="ban_status" name="ban_status" required>
                                        <option value="not_banned"
                                            {{ $user->ban_status == 'not_banned' ? 'selected' : '' }}>غير محظور</option>
                                        <option value="banned" {{ $user->ban_status == 'banned' ? 'selected' : '' }}>محظور
                                        </option>
                                    </select>
                                </div>
