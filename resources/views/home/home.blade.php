                ...
                <div class="card-header pb-0 p-3">
                    <div class="row align-items-center">
                        <div class="col-md-3 d-flex align-items-center">
                            <a href="{{ route('admin.projects.index') }}" class="btn bg-gradient-dark mb-0">
                ...
                <div class="card-body pt-4 p-3">
                    ...
                    <form action="" method="get">
                        <div class="row mt-2 mb-2">
                            ...
                            <div class="col-2 my-auto">
                                <a href="" class="my-auto btn bg-gradient-danger mt-2 w-100"><i class="fas fa-times"
                        ...
                        <div class="col-6 align-items-end text-end">
                            <button type="button" class="btn btn-sm bg-gradient-dark mb-0" data-bs-toggle="modal"
                                data-bs-target="#add-new-project"><i class="fas fa-plus"
                                    aria-hidden="true"></i>&nbsp;&nbsp;Add New Project</button>
                        </div>
                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="edit-project-form-project-name"
                                                                    class="form-control-label">Project Name</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="edit-project-form-project-color"
                                                                    class="form-control-label">Project Color</label>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="py-3 text-center">
                                                    ...
                                                    <h4 class="text-gradient text-danger mt-4">Are you sure you want to
                                                        delete!</h4>
                                                    <p>Are you sure you want to delete this project? Tasks that depend on it
